		...
		<div class="row align-items-center">
			...
			<div class="col-7">
				<div class="text-right upgrade-btn">
					<a href="adminpersonal" class="btn btn-success text-white">Agregar administrador</a>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="ml-auto">
								<div class="dl">
									<select class="custom-select">
										...
										<option value="1">No. Proveedores</option>
										<option value="2">Tipo de administrador</option>
					...
					<div class="table-responsive">
						<table class="table v-middle">
							...
							<tr class="bg-light">
								...
								<th class="border-top-0">No. proveedores</th>
							</tr>
							</thead>
							<tbody>
							<tr>
